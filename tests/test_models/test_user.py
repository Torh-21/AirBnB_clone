...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        dt_repr = repr(date_today)
        user = User()
        user.id = "123456"
        user.created_at = user.updated_at = date_today
    ...
    def test_instantiation_with_kwargs(self):
        ...
        self.assertEqual(user.created_at, date_today)
        self.assertEqual(user.updated_at, date_today)
